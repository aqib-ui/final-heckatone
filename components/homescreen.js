    ...
    return ((
        <View style={{ flex: 1 }}>
            ...
            <ImageBackground source={require('./assets/backgroundimg.jpg')} resizeMode={'cover'} style={{ flex: 1, width: null, height: null, }}>
                <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: 10, marginLeft: -90 }}>
                ...
                <Text style={{ textAlign: "center", fontSize: 24, fontWeight: "bold", color: "green", paddingTop: 40 }}>Welcome To AR Collegiate!</Text>
